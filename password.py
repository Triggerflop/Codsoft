...
def randPassGen():
    ...
    for y in range(pass_len.get()):
        ...
        #to randomize the occurance of alphabet, digit or symbol
...
pass_len = IntVar() 
#integer variable to store the input of length of the password wanted
length = Spinbox(root, from_ = 3, to_ = 25 , textvariable = pass_len , width = 24, font='arial 16').pack()
